...
export default function AuthModal() {
    const { isAuthModalOpen, closeAuthModal, authModalView, setAuthModalView, signIn, signUp, signInWithGoogle } = useAuth();
        ...
        <div style={{
            ...
            <div className="card" style={{
                ...
                <div style={{ position: 'relative', textAlign: 'center', margin: '20px 0' }}>
                    ...
                    <span style={{ position: 'absolute', top: '-10px', left: '50%', transform: 'translateX(-50%)', background: 'var(--color-bg-card)', padding: '0 10px', fontSize: '12px', color: 'var(--color-text-muted)' }}>o</span>
                </div>
