                            ...
                            {categories.map(cat => (
                                <button
                                    ...
                                    style={{
                                        padding: '8px 20px',
                                        borderRadius: 30,
                                        border: cat === selectedCategory ? '1px solid var(--color-primary)' : '1px solid var(--color-border)',
                                        background: cat === selectedCategory ? 'rgba(124,107,255,0.15)' : 'var(--color-input-bg)',
